...
<HTML class="kornflakesFlakes" id="FlakesShowKornflakes" lang="en">
  <HEAD>
      <TITLE> <?php echo $username;?>'s Flakes</TITLE>
  ...
  <BODY class="kornContent" onload="loadAllFlakes(),startNotification(), updatenotif(),loginstatus()">
   <SCRIPT type="text/javascript">
             function loadAllFlakes()
              {
                 document.getElementById("msg").innerHTML="<IMG src='/images/ajax-loader.gif' alt='loading' border=0 />";
                 var httpc;
                   ...
                   httpc.onreadystatechange= function()
                      {
                        if(httpc.readyState==4 && httpc.status==200)
                          {     
                              ...
                              document.getElementById("flakesBody").innerHTML = httpc.responseText;
                          }
                       }
                    httpc.open("get","flakesLoader.php?getal=1", true);
                    httpc.send();
                 }
    ...
    <br />   <br />
    <DIV style="background-color:#eeffee;text-align:right;border:solid 1px #ccffcc;font-family:arial;font-style:italic;font-size:29px;">
    FLAKES&trade;
    </DIV>
    <br />
    <DIV style="color:#909090;font-size:12px;text-align:right;font-style:italic;font-family:verdana;">Flakes is a plural word, as it sounds and will always remain plural.<br />
    Flakes is anything you speak about people, things, ideas & feelings around you and share it in your network.
    </DIV>
    <br /><br /><br /><br /><br /><br /><br /><br /><br />
    <DIV style="font-family:georgia,verdana,tahoma;font-size:32px;color:purple;">Share Seamlessly</DIV>
    <br /><DIV style="font-family:verdana;font-size:18px;">It's simple & fun!</div><br />
  
    <TEXTAREA id="flakes" name="flakes" style="width:500px;height:60px;font-family:tahoma;border:solid 1px #ccddee;color:#aaaaaa;overflow:auto;" onblur="bringw()" onfocus="areaBig()">Start here, say something.</TEXTAREA>
    <br /><br />
    <INPUT id="about" name="abt" onfocus="textclear()" onblur="bring()" type="text" style="border:solid 1px #ccddee;height:30px;color:#aaaaaa;width:500px;" value="I am saying something about" />
  
    <br /><br />
    <button type="button" id="button" name="flaker" style="width:500px;" onmouseover="this.style.backgroundColor='#ccccdd';" onmouseout="this.style.backgroundColor='#dddddd';" onmousedown="this.style.borderStyle='ridge';" onmouseup="this.style.borderStyle='groove'; this.style.backgroundColor='#dddddd';" onclick="loadFlakes()">Start Flaking</Button>
    ...
    <?php
       if($_GET['deleted']!='')
         {
         if($_GET['deleted']==1)
              echo "<DIV style='background-color:#ffdddd;border:solid 1px #ff9090;width:500px;'>Your Flakes was successfully deleted!</DIV>";
        ...
        if($_GET['hidden']!='')
          {   
          if($_GET['hidden']==1)
              echo "<DIV style='background-color:#ffdddd;border:solid 1px #ff9090;width:500px;'>Your Flakes was hidden. It will not be available in common room now.</DIV>";
           else if($_GET['hidden']==0)
             echo "<DIV style='background-color:#ffdddd;border:solid 1px #ff9090;width:500px;'>Some Error ocurred at ahens server. Please try later!</DIV>"; 
          }
        if($_GET['show']!='')
          {     
          if($_GET['show']==1)
              echo "<DIV style='background-color:#ffdddd;border:solid 1px #ff9090;width:500px;'>Your Flakes is now available in common room.</DIV>";
           else if($_GET['show']==0)
             echo "<DIV style='background-color:#ffdddd;border:solid 1px #ff9090;width:500px;'>Some Error ocurred at ahens server. Please try later!</DIV>"; 
          }  
    ...
    ?>                  
     ...
     <DIV id="flakesBody"></DIV> 
    <DIV style="font-family:'lucida sans unicode'; color:#ff90bb;text-align:center;">FLAKES&trade; is appreciably abuse-sensitive. Dive in fearlessly! </DIV><br /><br /><hr />
...
<span style="position:absolute;top:5px;left:305px;"><INPUT type="text" size="40" style="color:#989898;border:groove 1px #ff8080;text-align:center;font-family:'lucida sans unicode';" class="simple" id="qs" value="Quick Search" onfocus="clears(this.value)" onblur="get(this.value)" onkeyup="quicksearch(this.value,'<?php echo $campCode; ?>')"/></span>						
	...
	<DIV class="midPlate" style="top:265px;">
...
<!--	<DIV class="menu" id="menu" onmouseover="menuOver()" onmouseout="menuOut()">
  ...
  <DIV class="glassSignup2">
	...
	<DIV class="sideLink2" id="sideLnk4" onclick="location.href='flakes.php';">
	Flakes&trade; &gt;
	</DIV> 
...
<DIV style="font-weight:bold;" class="sideLink2" id="sideLnk6"  onmouseover="sidelinkover('sideLnk6')" onmouseout="sidelinkout('sideLnk6','The New Home')" onclick="location.href='http://kf.ahens.com/home/home.php';">
	 ...
	 <span style="font-size:15px;"> New ways to share your ideas. Soon with AHENS!</span>
