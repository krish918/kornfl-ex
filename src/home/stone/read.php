...
<HTML class="kornflakesSearch" id="profileIndex" lang="en">
  <HEAD>
      <TITLE>  Stone : Read Stories</TITLE>
  ...
  <BODY class="kornContent" onload="startNotification(), updatenotif(), bringstone(0,10), loginstatus()">
    ...
    <DIV class="mainContainer">
		...
		<br /><br /><br />
		<a href="share.php" id="stlink"> Share </a>
		<br /><br />
		...
		<?php if(isset($_GET['done']))
		          echo "<span style='background-color:#ffdddd;border:solid 1px #ff9090;padding:4px;'>Story published succesfully!</span>";
			   else if(isset($_GET['update']))
				    echo "<span style='background-color:#ffdddd;border:solid 1px #ff9090;padding:4px;'>Story updated succesfully!</span>";
		?>			
		</DIV>
