  ...
  <BODY class="kornContent" onload="startNotification(), updatenotif(), bringstone(0,15), loginstatus()">
    ...
    <DIV class="mainContainer">
		...
		<DIV class="readhead"><br />
		 <span style="font-size:16px;font-family:verdana;font-style:italic;">Showing most READ stories of the week</span>
		  ...
		  <DIV id="getstone">	
		 <?php
		 $sql =mysql_query("SELECT * FROM stone WHERE readCount<>0 ORDER BY readCount DESC LIMIT 0,10",$conStone); 
		  while($st = mysql_fetch_array($sql))
			{
			 ...
			 if($st['place']!='' && $st['sources']!='')
			 {
			   ?>
				 ...
				 <div style="color:#1C85D4;"><span style="font-size: 20px;"><?php echo $st['readCount']; ?></span> people</DIV>
			     </DIV>
				 </DIV>
				 <?php
				  $count++;
		...
		<br /><br />
		<div class="active">Most Read<div id="arrow"></div><div id="arrowin"></div></div>
		<br /><br /><br />
